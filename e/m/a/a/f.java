...
public class f implements Interpolator {
    ...
    public f(Resources resources, Resources.Theme theme, AttributeSet attributeSet, XmlPullParser xmlPullParser) {
        TypedArray k2 = g.k(resources, theme, attributeSet, a.l);
        d(k2, xmlPullParser);
        k2.recycle();
    }
    ...
    private void b(Path path) {
        ...
        if (min > 0) {
            ...
            if (Math.abs(this.a[0]) <= 1.0E-5d && Math.abs(this.b[0]) <= 1.0E-5d) {
                int i4 = min - 1;
                if (Math.abs(this.a[i4] - 1.0f) <= 1.0E-5d && Math.abs(this.b[i4] - 1.0f) <= 1.0E-5d) {
                    float f2 = 0.0f;
                    int i5 = 0;
                    while (i2 < min) {
                        float[] fArr2 = this.a;
    ...
    private void d(TypedArray typedArray, XmlPullParser xmlPullParser) {
        if (g.j(xmlPullParser, "pathData")) {
            String i2 = g.i(typedArray, xmlPullParser, "pathData", 4);
            Path e2 = c.e(i2);
            if (e2 != null) {
                b(e2);
                return;
            ...
            boolean j2 = g.j(xmlPullParser, "controlX2");
            if (j2 != g.j(xmlPullParser, "controlY2")) {
