...
public abstract class z {
    ...
    class a implements Runnable {
        ...
        final /* synthetic */ ArrayList f852g;

        /* renamed from: h  reason: collision with root package name */
        final /* synthetic */ ArrayList f853h;

        /* renamed from: i  reason: collision with root package name */
        final /* synthetic */ ArrayList f854i;

        a(z zVar, int i2, ArrayList arrayList, ArrayList arrayList2, ArrayList arrayList3, ArrayList arrayList4) {
            this.f850e = i2;
            this.f851f = arrayList;
            this.f852g = arrayList2;
            this.f853h = arrayList3;
            this.f854i = arrayList4;
        }

        @Override // java.lang.Runnable
        public void run() {
            for (int i2 = 0; i2 < this.f850e; i2++) {
                u.S((View) this.f851f.get(i2), (String) this.f852g.get(i2));
                u.S((View) this.f853h.get(i2), (String) this.f854i.get(i2));
            }
        }
    }
    ...
    class b implements Runnable {
        ...
        /* renamed from: e  reason: collision with root package name */
        final /* synthetic */ ArrayList f855e;

        /* renamed from: f  reason: collision with root package name */
        final /* synthetic */ Map f856f;
        ...
        @Override // java.lang.Runnable
        public void run() {
            int size = this.f855e.size();
            for (int i2 = 0; i2 < size; i2++) {
                View view = (View) this.f855e.get(i2);
                String t = u.t(view);
                if (t != null) {
                    u.S(view, z.i(this.f856f, t));
                }
            }
        }
    }
    ...
    class c implements Runnable {
        ...
        /* renamed from: e  reason: collision with root package name */
        final /* synthetic */ ArrayList f857e;

        /* renamed from: f  reason: collision with root package name */
        final /* synthetic */ Map f858f;
        ...
        public void run() {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                View view = (View) this.f857e.get(i2);
                u.S(view, (String) this.f858f.get(u.t(view)));
            }
        }
    }
            ...
            for (int i2 = size; i2 < list.size(); i2++) {
                ...
                if (view2 instanceof ViewGroup) {
                    ...
                    for (int i3 = 0; i3 < childCount; i3++) {
                        ...
                        if (!h(list, childAt, size) && u.t(childAt) != null) {
                            list.add(childAt);
                        }
                    }
                }
