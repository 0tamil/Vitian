...
public final class Version implements Comparable<Version> {
    ...
    private Version(int i2, int i3, int i4, String str) {
        ...
        a = h.a(new Version$bigInteger$2(this));
        this.bigInteger$delegate = a;
    }

    public /* synthetic */ Version(int i2, int i3, int i4, String str, e eVar) {
        this(i2, i3, i4, str);
    }
    ...
    public String toString() {
        ...
        String i2 = l ^ true ? i.i("-", this.description) : "";
        return this.major + '.' + this.minor + '.' + this.patch + i2;
    }
}
